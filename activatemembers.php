...
include 'connect.php';
            ...
            $stmt = $con->prepare("select * from register where priority=0 " );
            $stmt->execute();
            $rows = $stmt->fetchAll();
                                                    ...
                                                    <div class="col-12 h-100">
                                                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                                                            <div class="academy-logo">
                                                                <a href="activatemembers.php"><img src="img/core-img/logo.png" alt=""></a>
                                                            </div>
            ...
            <tr style="background-color: black; color: white">
                ...
                foreach ($rows as $row) {
                    echo "<tr>"; 
                         ...
                         echo " <a href='activerespons.php?id=".$row['id']."'class='btn btn-warning'>  Voluntary Employer </a>";
                         echo "</td>";   
                    echo "</tr>";
                  }
