...
$stmt1 = $con->prepare("select * from detail where counter < number");
$stmt1->execute();
// $stmt->execute();
...
<html lang="en">
        ...
        <ul class="navbar-nav ml-auto">
           <li class="nav-item active"><a href="volunteer.php" class="nav-link">Home</a></li>
            <?php
                        ...
                        $count = $stmt->rowcount();
                        if($count >0){
                            echo ' <li class="nav-item active"> <a href="messages1.php" class="nav-link" style="color: yellow;"> messages</a></li>';
   
                        } else {
                             echo ' <li class="nav-item active"> <a href="messages1.php" class="nav-link"> messages</a></li>';
                        }
  ...
  <input style="background-color: #E6E6E6" type="text" placeholder="Search.." name="search">
  <input type="submit" class="example" value="search" >
</form>
...
foreach ($rowss as $row) {
    ...
    if ($count2 > 0) {
            ...
            if ( in_array($row["id"], $rowsss[$i]) == 1  ) {        
                echo 'you are already submit<br>';
                $i++;
                break ;
                
                
            } else {  
                echo "<a  href='counter.php?id=" . $row["id"] . "' class='btn btn-warning' id='agree' >Submit</a><br><br>"; 
                break ;
        ...
        echo "<a  href='edite.php?id=" . $row["id"] . "' class='btn btn-warning' id='agree' >Send Massage</a>";
